...
export default async function IntegrationsPage() {
  ...
  if (business) {
    ...
    /* ⚠ La Pepita nu exista `connected`: nu avem cum sa aflam ca EI au acceptat conexiunea.
       Steagul spune doar ca integrarea e pornita la noi si ca are adresele generate. */
    const pep = settings?.pepita_config as { activ?: boolean } | null;
    pepitaActive = pep?.activ === true;
