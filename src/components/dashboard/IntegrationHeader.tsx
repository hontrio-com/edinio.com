...
const LOGOS: Record<string, { src: string; alt: string; filter?: string }> = {
  ...
  sameday: { src: "/integrations/sameday.svg", alt: "Sameday" },
  woot: { src: "/integrations/woot.svg", alt: "Woot", filter: "invert(1)" },
  colete: { src: "/integrations/colete-online.svg", alt: "Colete Online" },
  smartbill: { src: "/integrations/smartbill.svg", alt: "SmartBill" },
