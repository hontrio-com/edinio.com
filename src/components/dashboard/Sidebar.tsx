...
function NavItem({ href, icon: Icon, label, active, badge = 0, beta = false, nou = false }: {
  href: string; icon: React.ComponentType<{ className?: string }>; label: string; active: boolean; badge?: number; beta?: boolean; nou?: boolean;
}) {
  return (
