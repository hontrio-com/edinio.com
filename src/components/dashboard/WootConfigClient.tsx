    ...
    <div className="p-6 max-w-2xl">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div className="flex items-center gap-2">
          <img src="/integrations/woot.svg" alt="Woot" className="h-5 w-auto object-contain" style={{ filter: "invert(1)" }} />
          <span className="text-sm font-semibold text-foreground">Woot.ro</span>
        </div>
        {isConnected && (
