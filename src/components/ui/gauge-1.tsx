...
/*
 * ⚠ COMPONENTĂ ADUSĂ DIN AFARĂ, PĂSTRATĂ CUM A VENIT.
 *
 * Trimisă de client (2026-08-13) pentru cadranele de pe pagina „Optimizare", cu
 * cererea explicită de a fi folosită ca atare. E copiată literal: același cod,
 * aceleași nume, aceeași structură. Importul de `cn` a mers neatins — proiectul
 * chiar are `@/lib/utils`.
 *
 * Nu se rescrie și nu se „curăță". Dacă vine o versiune nouă de la el, se
 * înlocuiește fișierul întreg.
 *
