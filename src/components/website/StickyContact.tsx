  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-2.5">
      ...
      <a
        ...
        className="group w-12 h-12 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-lg shadow-[#25D366]/30 hover:scale-110 transition-transform"
