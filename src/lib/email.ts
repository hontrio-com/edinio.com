...
const TEXTE_COD: Record<SablonCod, { subiect: string; titlu: string; text: (magazin: string) => string; nota: string }> = {
  inregistrare: {
    ...
    text: (m) => `Ca sa-ti creezi contul pe ${m}, introdu codul de mai jos pe pagina magazinului.`,
  ...
  "doi-pasi": {
    ...
    titlu: "Codul tau de autentificare",
    text: (m) => `S-a introdus parola corecta pentru contul tau de pe ${m}. Daca esti tu, introdu codul de mai jos ca sa intri in cont.`,
    nota: "Daca nu ai fost tu, schimba-ti parola, pentru ca altcineva o cunoaste. Fara acest cod nu poate intra.",
  },
  "resetare-parola": {
    subiect: "Resetarea parolei",
    titlu: "Seteaza o parola noua",
    text: (m) => `Ai cerut o parola noua pentru contul tau de pe ${m}. Introdu codul de mai jos, impreuna cu parola noua.`,
  ...
  "adaugare-contact": {
    ...
    text: (m) => `Ai adaugat adresa asta in contul tau de pe ${m}. Introdu codul ca s-o confirmi.`,
