...
/*
 * ⚠ MUTATE in `@/lib/utils/zile-lucratoare`, 2026-09-02, cand Posta Romana a avut
 * nevoie de aceleasi doua functii. Se RE-EXPORTA de aici, ca apelantii si probele
 * Pall-Ex sa ramana neatinsi — si ca sa nu apara o a doua copie a unei reguli de
 * calendar, care s-ar fi despartit de prima la primul defect reparat.
 *
 * `oraNormalizata` ramane mai jos: e despre ferestrele orare ale partidei, adica
 * despre Pall-Ex, nu despre calendar.
 */
export { adaugaZileLucratoare, inainteDe, ziuaInRomania } from "@/lib/utils/zile-lucratoare";
