 ...
 *
 * ⚠ MUTAT AICI DIN `src/lib/emag` PE 26.08.2026, cand auditul Trendyol a gasit ACEEASI clasa
 * de defect acolo: `syncProductNow` citea produsul cu `maybeSingle()` fara `error`, iar un
 * `data: null` venit dintr-o pana o lua drept „produsul a fost sters" — si intra pe calea
 * care sterge listarea de la Trendyol. Regula era scrisa, dar sta intr-un folder in care
 * Trendyol n-avea cum s-o vada.
 *
...
import { citireCazuta } from "./citire";
